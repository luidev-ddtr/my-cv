(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const t of i)if(t.type==="childList")for(const a of t.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function o(i){const t={};return i.integrity&&(t.integrity=i.integrity),i.referrerPolicy&&(t.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?t.credentials="include":i.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(i){if(i.ep)return;i.ep=!0;const t=o(i);fetch(i.href,t)}})();const l={name:"Luis Tepetate",email:"luistepetate1@gmail.com",linkedin:"https://www.linkedin.com/in/luis-tepetate",education:{degree:"Software Engineer Bachelor's Degree",university:"Universidad Tecnológica del Valle del Mezquital (UTVM)",location:"Hidalgo, Mexico",dates:"Aug 2024 – Present"},skills:{programming_languages:"Python, SQL, C#, JavaScript",web_development:"Flask, Django, FastAPI",frontend_basics:"React, Astro, Vite",version_control:"Git, GitHub",devops:"Automation, Deployment"},experience:[{company:"Ixmiquilpan Community Organization",role:"Full Stack Developer & Systems Consultant",location:"Ixmiquilpan, Hidalgo, Mexico",dates:"Jan 2025 – Oct 2025",responsibilities:["Designed and deployed a centralized Community Management Web System using Flask and SQLite, reducing record lookup time by 94% and improving decision-making efficiency across departments.","Automated attendance tracking and debt assessment workflows, increasing operational efficiency by over 80% and enabling real-time compliance validation.","Led the migration from physical ledgers to a persistent digital database with automated cloud backups, ensuring long-term data integrity and eliminating the risk of unauthorized deletions."]}],awards:[{title:"Praxis Hackathon",place:"6th Place",date:"March 2025",location:"Hidalgo, Mexico"}],certifications:["Cisco: CCNA Routing and Switching Certification.","Cisco: CCNA Certified Network Associate"]};document.addEventListener("DOMContentLoaded",()=>{console.log(l),r(l)});function r(e){const s=document.getElementById("cv-container"),o=`
    ...
    <section class="experience">
      ...
      ${e.experience.map(n=>`
        <div class="job">
          <h3>${n.company}</h3>
          <div class="company">${n.role}</div><br>
          <div class="dates"><strong>${n.dates}</strong><br>${n.location}</div>
          <ul>
            ${n.responsibilities.map(i=>`<li>${i}</li>`).join("")}
          </ul>
        </div>
      `).join("")}
    </section>
      ...
      ${e.awards.map(n=>`
        <div class="item">
          <div class="award-entry-line">
            <h3>${n.title} ${n.place}</h3>
            <div class="details"><strong>${n.date}</strong>  - ${n.location}</div>
          </div>
        </div>
      `).join("")}
    </section>
    ...
    <section class="certifications">
      ...
      <div class="linea">-</div>
      <ul>
        ${e.certifications.map(n=>`<li>${n}</li>`).join("")}
      </ul>
    </section>
  `;s.innerHTML=o}
